# Sets enterprise users from Box to Read-Only, Active or Inactive. 
# Uses a CSV user list that you provide (can export using Export Box Users script) and an exclusion list to ignore any users if needed
...
$usersFile = $ScriptLocation + "CSVFiles\users.csv"
...
$scriptName = "Update Box Enterprise Users Status From Import CSV Script"
...
{
        GetLogger "Importing Box enterprise users from CSV file..." $true
